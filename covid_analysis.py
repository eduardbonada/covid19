...
# TODO: Plot with evolution of different values
...
plots = ['daily_confirmed', 'active_confirmed', 'epg', 'ia14_rho7']
...
if 'epg' in plots:
    cov19.plot_epg(mode='show', data=area_data, title='Effective Potential Growth (EPG) {}'.format(area),
                   column_date='Date')
